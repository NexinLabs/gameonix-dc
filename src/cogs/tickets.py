...
class Ticket(commands.Cog):
    ...
    @commands.hybrid_command(with_app_command = True, description="Setup Ticket System")
    @commands.guild_only()
    ...
    async def on_interaction(self, interaction:Interaction):
        ...
        if interaction.data["custom_id"] == f"{self.bot.user.id}-ticket":
            ...
            embed = Embed(title="Ticket Created", description=f"**{emoji.A_ARROW}Thanks for contacting\n{emoji.A_ARROW}Feel free to communicate**", color=color.GREEN)
